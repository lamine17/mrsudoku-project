...
return cljs.core.map.call(null,(function (p1__12065_SHARP_){
return html_coll.item(p1__12065_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__12066_SHARP_);
...
var ctx_12067 = cvs.getContext("2d");
ctx_12067.fillStyle = color;

ctx_12067.fillRect((0),(0),size,size);
