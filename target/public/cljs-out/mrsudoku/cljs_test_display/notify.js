...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__14121){
var map__14122 = p__14121;
var map__14122__$1 = ((((!((map__14122 == null)))?(((((map__14122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14122.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14122):map__14122);
var error = cljs.core.get.call(null,map__14122__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__14122__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__14122,map__14122__$1,error,fail){
return (function (){
...
});})(map__14122,map__14122__$1,error,fail))
);
});
