...
var G__11906 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11906,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11906;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11908){
var G__11909 = cljs.core.first.call(null,seq11908);
var seq11908__$1 = cljs.core.next.call(null,seq11908);
var G__11910 = cljs.core.first.call(null,seq11908__$1);
var seq11908__$2 = cljs.core.next.call(null,seq11908__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11909,G__11910,seq11908__$2);
});
...
var file = cljs.core.get.call(null,map__11915__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11915__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11915__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11915,map__11915__$1,file,line,column){
return (function (p1__11914_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11914_SHARP_));
});})(map__11915,map__11915__$1,file,line,column))
...
var temp__5720__auto___11917 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11917)){
var message_11918 = temp__5720__auto___11917;
cljs.core.println.call(null,message_11918);
} else {
}
...
var temp__5720__auto___11919 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11919)){
var message_11920 = temp__5720__auto___11919;
cljs.core.println.call(null,message_11920);
} else {
}
...
var output_dir__$1 = (function (){var G__11921 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11921),"/"].join('');
} else {
return G__11921;
}
})();
...
var G__11923 = exception.stack;
var G__11923__$1 = (((G__11923 == null))?null:clojure.string.split_lines.call(null,G__11923));
var G__11923__$2 = (((G__11923__$1 == null))?null:cljs.core.get.call(null,G__11923__$1,depth));
if((G__11923__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11923__$2);
}
} else {
...
var vec__11924 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11924,(0),null);
var column = cljs.core.nth.call(null,vec__11924,(1),null);
var vec__11927 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11927,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11927,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11927,(2),null);
...
var m__$1 = (function (){var G__11930 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11934 = (function (){var G__11933 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11933);
} else {
return G__11933;
}
})();
...
return cljs.core.vary_meta.call(null,G__11935,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11939 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11939,(0),null);
var types = vec__11939;
...
return cljs.core.map.call(null,(function (p__11942){
var vec__11943 = p__11942;
var ns = cljs.core.nth.call(null,vec__11943,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11943,(1),null);
return ((function (vec__11943,ns,vars__$1){
return (function (){
...
var G__11946 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1){
return (function (){
var seq__11947 = cljs.core.seq.call(null,vars__$1);
var chunk__11948 = null;
var count__11949 = (0);
var i__11950 = (0);
while(true){
if((i__11950 < count__11949)){
var v = cljs.core._nth.call(null,chunk__11948,i__11950);
var temp__5720__auto___11952 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11952)){
var t_11953 = temp__5720__auto___11952;
each_fixture_fn.call(null,((function (seq__11947,chunk__11948,count__11949,i__11950,t_11953,temp__5720__auto___11952,v,each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11953)));
});})(seq__11947,chunk__11948,count__11949,i__11950,t_11953,temp__5720__auto___11952,v,each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1))
);
} else {
}


var G__11954 = seq__11947;
var G__11955 = chunk__11948;
var G__11956 = count__11949;
var G__11957 = (i__11950 + (1));
seq__11947 = G__11954;
chunk__11948 = G__11955;
count__11949 = G__11956;
i__11950 = G__11957;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11947);
if(temp__5720__auto__){
var seq__11947__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11947__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__11947__$1);
var G__11958 = cljs.core.chunk_rest.call(null,seq__11947__$1);
var G__11959 = c__4351__auto__;
var G__11960 = cljs.core.count.call(null,c__4351__auto__);
var G__11961 = (0);
seq__11947 = G__11958;
chunk__11948 = G__11959;
count__11949 = G__11960;
i__11950 = G__11961;
continue;
} else {
var v = cljs.core.first.call(null,seq__11947__$1);
var temp__5720__auto___11962__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11962__$1)){
var t_11963 = temp__5720__auto___11962__$1;
each_fixture_fn.call(null,((function (seq__11947,chunk__11948,count__11949,i__11950,t_11963,temp__5720__auto___11962__$1,v,seq__11947__$1,temp__5720__auto__,each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11963)));
});})(seq__11947,chunk__11948,count__11949,i__11950,t_11963,temp__5720__auto___11962__$1,v,seq__11947__$1,temp__5720__auto__,each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1))
);
} else {
}


var G__11964 = cljs.core.next.call(null,seq__11947__$1);
var G__11965 = null;
var G__11966 = (0);
var G__11967 = (0);
seq__11947 = G__11964;
chunk__11948 = G__11965;
count__11949 = G__11966;
i__11950 = G__11967;
continue;
}
} else {
...
});})(each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1))
);
});})(each_fixture_fn,G__11946,G__11946__$1,env,once_fixtures,each_fixtures,vec__11943,ns,vars__$1))
], null);
