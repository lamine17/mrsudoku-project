...
return cljs.core.assoc.call(null,G__11909,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11909;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11911){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11912,G__11913,seq11911__$2);
});
...
var file = cljs.core.get.call(null,map__11918__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11918__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11918__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11918,map__11918__$1,file,line,column){
return (function (p1__11917_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11917_SHARP_));
});})(map__11918,map__11918__$1,file,line,column))
...
var temp__5720__auto___11920 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11920)){
var message_11921 = temp__5720__auto___11920;
cljs.core.println.call(null,message_11921);
} else {
}
...
var temp__5720__auto___11922 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11922)){
var message_11923 = temp__5720__auto___11922;
cljs.core.println.call(null,message_11923);
} else {
}
...
var output_dir__$1 = (function (){var G__11924 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11924),"/"].join('');
} else {
return G__11924;
}
})();
...
var G__11926 = exception.stack;
var G__11926__$1 = (((G__11926 == null))?null:clojure.string.split_lines.call(null,G__11926));
var G__11926__$2 = (((G__11926__$1 == null))?null:cljs.core.get.call(null,G__11926__$1,depth));
if((G__11926__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11926__$2);
}
} else {
...
var vec__11927 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11927,(0),null);
var column = cljs.core.nth.call(null,vec__11927,(1),null);
var vec__11930 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11930,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11930,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11930,(2),null);
...
var m__$1 = (function (){var G__11933 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11937 = (function (){var G__11936 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11936);
} else {
return G__11936;
}
})();
...
return cljs.core.vary_meta.call(null,G__11938,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11942 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11942,(0),null);
var types = vec__11942;
...
return cljs.core.map.call(null,(function (p__11945){
var vec__11946 = p__11945;
var ns = cljs.core.nth.call(null,vec__11946,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11946,(1),null);
return ((function (vec__11946,ns,vars__$1){
return (function (){
...
var G__11949 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11949__$1 = (((G__11949 instanceof cljs.core.Keyword))?G__11949.fqn:null);
switch (G__11949__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1){
return (function (){
var seq__11950 = cljs.core.seq.call(null,vars__$1);
var chunk__11951 = null;
var count__11952 = (0);
var i__11953 = (0);
while(true){
if((i__11953 < count__11952)){
var v = cljs.core._nth.call(null,chunk__11951,i__11953);
var temp__5720__auto___11955 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11955)){
var t_11956 = temp__5720__auto___11955;
each_fixture_fn.call(null,((function (seq__11950,chunk__11951,count__11952,i__11953,t_11956,temp__5720__auto___11955,v,each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11956)));
});})(seq__11950,chunk__11951,count__11952,i__11953,t_11956,temp__5720__auto___11955,v,each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1))
);
} else {
}


var G__11957 = seq__11950;
var G__11958 = chunk__11951;
var G__11959 = count__11952;
var G__11960 = (i__11953 + (1));
seq__11950 = G__11957;
chunk__11951 = G__11958;
count__11952 = G__11959;
i__11953 = G__11960;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11950);
if(temp__5720__auto__){
var seq__11950__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11950__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__11950__$1);
var G__11961 = cljs.core.chunk_rest.call(null,seq__11950__$1);
var G__11962 = c__4351__auto__;
var G__11963 = cljs.core.count.call(null,c__4351__auto__);
var G__11964 = (0);
seq__11950 = G__11961;
chunk__11951 = G__11962;
count__11952 = G__11963;
i__11953 = G__11964;
continue;
} else {
var v = cljs.core.first.call(null,seq__11950__$1);
var temp__5720__auto___11965__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11965__$1)){
var t_11966 = temp__5720__auto___11965__$1;
each_fixture_fn.call(null,((function (seq__11950,chunk__11951,count__11952,i__11953,t_11966,temp__5720__auto___11965__$1,v,seq__11950__$1,temp__5720__auto__,each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11966)));
});})(seq__11950,chunk__11951,count__11952,i__11953,t_11966,temp__5720__auto___11965__$1,v,seq__11950__$1,temp__5720__auto__,each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1))
);
} else {
}


var G__11967 = cljs.core.next.call(null,seq__11950__$1);
var G__11968 = null;
var G__11969 = (0);
var G__11970 = (0);
seq__11950 = G__11967;
chunk__11951 = G__11968;
count__11952 = G__11969;
i__11953 = G__11970;
continue;
}
} else {
...
});})(each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1))
);
});})(each_fixture_fn,G__11949,G__11949__$1,env,once_fixtures,each_fixtures,vec__11946,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11949__$1)].join('')));

}
})());
});
;})(vec__11946,ns,vars__$1))
