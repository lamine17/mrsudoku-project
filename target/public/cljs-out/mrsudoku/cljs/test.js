...
var G__11929 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11929,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11929;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11931){
var G__11932 = cljs.core.first.call(null,seq11931);
var seq11931__$1 = cljs.core.next.call(null,seq11931);
var G__11933 = cljs.core.first.call(null,seq11931__$1);
var seq11931__$2 = cljs.core.next.call(null,seq11931__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11932,G__11933,seq11931__$2);
});
...
var map__11938 = m;
var map__11938__$1 = ((((!((map__11938 == null)))?(((((map__11938.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11938.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11938):map__11938);
var file = cljs.core.get.call(null,map__11938__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11938__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11938__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11938,map__11938__$1,file,line,column){
return (function (p1__11937_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11937_SHARP_));
});})(map__11938,map__11938__$1,file,line,column))
...
var temp__5720__auto___11940 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11940)){
var message_11941 = temp__5720__auto___11940;
cljs.core.println.call(null,message_11941);
} else {
}
...
var temp__5720__auto___11942 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11942)){
var message_11943 = temp__5720__auto___11942;
cljs.core.println.call(null,message_11943);
} else {
}
...
var output_dir__$1 = (function (){var G__11944 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11944),"/"].join('');
} else {
return G__11944;
}
})();
...
var G__11946 = exception.stack;
var G__11946__$1 = (((G__11946 == null))?null:clojure.string.split_lines.call(null,G__11946));
var G__11946__$2 = (((G__11946__$1 == null))?null:cljs.core.get.call(null,G__11946__$1,depth));
if((G__11946__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11946__$2);
}
} else {
...
var vec__11947 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11947,(0),null);
var column = cljs.core.nth.call(null,vec__11947,(1),null);
var vec__11950 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11950,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11950,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11950,(2),null);
...
var m__$1 = (function (){var G__11953 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11953__$1 = (((G__11953 instanceof cljs.core.Keyword))?G__11953.fqn:null);
switch (G__11953__$1) {
case "fail":
...
var G__11957 = (function (){var G__11956 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11956);
} else {
return G__11956;
}
})();
...
return cljs.core.vary_meta.call(null,G__11958,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11959){var e = e11959;
var G__11960 = e;
var G__11960__$1 = (((G__11960 instanceof cljs.core.Keyword))?G__11960.fqn:null);
switch (G__11960__$1) {
...
var vec__11962 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11962,(0),null);
var types = vec__11962;
...
return cljs.core.map.call(null,(function (p__11965){
var vec__11966 = p__11965;
var ns = cljs.core.nth.call(null,vec__11966,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11966,(1),null);
return ((function (vec__11966,ns,vars__$1){
return (function (){
...
var G__11969 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11969__$1 = (((G__11969 instanceof cljs.core.Keyword))?G__11969.fqn:null);
switch (G__11969__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1){
return (function (){
var seq__11970 = cljs.core.seq.call(null,vars__$1);
var chunk__11971 = null;
var count__11972 = (0);
var i__11973 = (0);
while(true){
if((i__11973 < count__11972)){
var v = cljs.core._nth.call(null,chunk__11971,i__11973);
var temp__5720__auto___11975 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11975)){
var t_11976 = temp__5720__auto___11975;
each_fixture_fn.call(null,((function (seq__11970,chunk__11971,count__11972,i__11973,t_11976,temp__5720__auto___11975,v,each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11976)));
});})(seq__11970,chunk__11971,count__11972,i__11973,t_11976,temp__5720__auto___11975,v,each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1))
);
} else {
}


var G__11977 = seq__11970;
var G__11978 = chunk__11971;
var G__11979 = count__11972;
var G__11980 = (i__11973 + (1));
seq__11970 = G__11977;
chunk__11971 = G__11978;
count__11972 = G__11979;
i__11973 = G__11980;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11970);
if(temp__5720__auto__){
var seq__11970__$1 = temp__5720__auto__;
...
var G__11981 = cljs.core.chunk_rest.call(null,seq__11970__$1);
var G__11982 = c__4351__auto__;
var G__11983 = cljs.core.count.call(null,c__4351__auto__);
var G__11984 = (0);
seq__11970 = G__11981;
chunk__11971 = G__11982;
count__11972 = G__11983;
i__11973 = G__11984;
continue;
} else {
var v = cljs.core.first.call(null,seq__11970__$1);
var temp__5720__auto___11985__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11985__$1)){
var t_11986 = temp__5720__auto___11985__$1;
each_fixture_fn.call(null,((function (seq__11970,chunk__11971,count__11972,i__11973,t_11986,temp__5720__auto___11985__$1,v,seq__11970__$1,temp__5720__auto__,each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11986)));
});})(seq__11970,chunk__11971,count__11972,i__11973,t_11986,temp__5720__auto___11985__$1,v,seq__11970__$1,temp__5720__auto__,each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1))
);
} else {
}


var G__11987 = cljs.core.next.call(null,seq__11970__$1);
var G__11988 = null;
var G__11989 = (0);
var G__11990 = (0);
seq__11970 = G__11987;
chunk__11971 = G__11988;
count__11972 = G__11989;
i__11973 = G__11990;
continue;
}
} else {
...
});})(each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1))
);
});})(each_fixture_fn,G__11969,G__11969__$1,env,once_fixtures,each_fixtures,vec__11966,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11969__$1)].join('')));

}
})());
});
;})(vec__11966,ns,vars__$1))
