...
var G__10493 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10493,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10493;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10495){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10496,G__10497,seq10495__$2);
});
...
var file = cljs.core.get.call(null,map__10502__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10502__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10502__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10502,map__10502__$1,file,line,column){
return (function (p1__10501_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10501_SHARP_));
});})(map__10502,map__10502__$1,file,line,column))
...
var temp__5720__auto___10504 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10504)){
var message_10505 = temp__5720__auto___10504;
cljs.core.println.call(null,message_10505);
} else {
}
...
var temp__5720__auto___10506 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10506)){
var message_10507 = temp__5720__auto___10506;
cljs.core.println.call(null,message_10507);
} else {
}
...
var output_dir__$1 = (function (){var G__10508 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10508),"/"].join('');
} else {
return G__10508;
}
})();
...
var G__10510 = exception.stack;
var G__10510__$1 = (((G__10510 == null))?null:clojure.string.split_lines.call(null,G__10510));
var G__10510__$2 = (((G__10510__$1 == null))?null:cljs.core.get.call(null,G__10510__$1,depth));
if((G__10510__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10510__$2);
}
} else {
...
var vec__10511 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10511,(0),null);
var column = cljs.core.nth.call(null,vec__10511,(1),null);
var vec__10514 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10514,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10514,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10514,(2),null);
...
var m__$1 = (function (){var G__10517 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10521 = (function (){var G__10520 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10520);
} else {
return G__10520;
}
})();
...
return cljs.core.vary_meta.call(null,G__10522,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10523){var e = e10523;
var G__10524 = e;
var G__10524__$1 = (((G__10524 instanceof cljs.core.Keyword))?G__10524.fqn:null);
switch (G__10524__$1) {
...
var vec__10526 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10526,(0),null);
var types = vec__10526;
...
return cljs.core.map.call(null,(function (p__10529){
var vec__10530 = p__10529;
var ns = cljs.core.nth.call(null,vec__10530,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10530,(1),null);
return ((function (vec__10530,ns,vars__$1){
return (function (){
...
var G__10533 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1){
return (function (){
var seq__10534 = cljs.core.seq.call(null,vars__$1);
var chunk__10535 = null;
var count__10536 = (0);
var i__10537 = (0);
while(true){
if((i__10537 < count__10536)){
var v = cljs.core._nth.call(null,chunk__10535,i__10537);
var temp__5720__auto___10539 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10539)){
var t_10540 = temp__5720__auto___10539;
each_fixture_fn.call(null,((function (seq__10534,chunk__10535,count__10536,i__10537,t_10540,temp__5720__auto___10539,v,each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10540)));
});})(seq__10534,chunk__10535,count__10536,i__10537,t_10540,temp__5720__auto___10539,v,each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1))
);
} else {
}


var G__10541 = seq__10534;
var G__10542 = chunk__10535;
var G__10543 = count__10536;
var G__10544 = (i__10537 + (1));
seq__10534 = G__10541;
chunk__10535 = G__10542;
count__10536 = G__10543;
i__10537 = G__10544;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__10534);
if(temp__5720__auto__){
var seq__10534__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10534__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__10534__$1);
var G__10545 = cljs.core.chunk_rest.call(null,seq__10534__$1);
var G__10546 = c__4351__auto__;
var G__10547 = cljs.core.count.call(null,c__4351__auto__);
var G__10548 = (0);
seq__10534 = G__10545;
chunk__10535 = G__10546;
count__10536 = G__10547;
i__10537 = G__10548;
continue;
} else {
var v = cljs.core.first.call(null,seq__10534__$1);
var temp__5720__auto___10549__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___10549__$1)){
var t_10550 = temp__5720__auto___10549__$1;
each_fixture_fn.call(null,((function (seq__10534,chunk__10535,count__10536,i__10537,t_10550,temp__5720__auto___10549__$1,v,seq__10534__$1,temp__5720__auto__,each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10550)));
});})(seq__10534,chunk__10535,count__10536,i__10537,t_10550,temp__5720__auto___10549__$1,v,seq__10534__$1,temp__5720__auto__,each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1))
);
} else {
}


var G__10551 = cljs.core.next.call(null,seq__10534__$1);
var G__10552 = null;
var G__10553 = (0);
var G__10554 = (0);
seq__10534 = G__10551;
chunk__10535 = G__10552;
count__10536 = G__10553;
i__10537 = G__10554;
continue;
}
} else {
...
});})(each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1))
);
});})(each_fixture_fn,G__10533,G__10533__$1,env,once_fixtures,each_fixtures,vec__10530,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10533__$1)].join('')));

}
})());
});
;})(vec__10530,ns,vars__$1))
