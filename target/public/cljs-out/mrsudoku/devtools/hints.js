...
var file = cljs.core.get.call(null,map__19676__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e19675){var _e = e19675;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___19678 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___19678)){
var seen_errors_19679 = temp__5718__auto___19678;
if(cljs.core.truth_(seen_errors_19679.has(self))){
} else {
seen_errors_19679.add(self);

var temp__5720__auto___19680 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___19680)){
var sense_19681 = temp__5720__auto___19680;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19681)].join('');
} else {
}
}
} else {
