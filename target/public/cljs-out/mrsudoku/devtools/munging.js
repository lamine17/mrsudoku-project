...
var o16148 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16148["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16149 = temp__5718__auto____$1;
return (o16149["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15158__auto__ = f;
return (o__15158__auto__["toString"]).call(o__15158__auto__);
} else {
return "";
}
}catch (e16150){var _ = e16150;
return "";
}});
...
try{var o__15158__auto___16152 = t;
(o__15158__auto___16152["cljs$lang$ctorPrWriter"]).call(o__15158__auto___16152,t,writer);
}catch (e16151){var __16153 = e16151;
}
...
var char_code = (function (){var o__15158__auto__ = (new String(char$));
return (o__15158__auto__["charCodeAt"]).call(o__15158__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15158__auto__ = String;
return (o__15158__auto__["fromCharCode"]).call(o__15158__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16154 = num_code;
switch (G__16154) {
case (1):
return (185);
...
var o__15158__auto__ = String;
return (o__15158__auto__["fromCharCode"]).call(o__15158__auto__,superscript_code);
});
/**
...
}catch (e16156){var _e__15165__auto__ = e16156;
return false;
}})())){
...
var vec__16157 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16157,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o16160 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16160["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16161 = temp__5718__auto____$1;
return (o16161["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___16168 = arguments.length;
var i__4532__auto___16169 = (0);
while(true){
if((i__4532__auto___16169 < len__4531__auto___16168)){
args__4534__auto__.push((arguments[i__4532__auto___16169]));

var G__16170 = (i__4532__auto___16169 + (1));
i__4532__auto___16169 = G__16170;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16164){
var vec__16165 = p__16164;
var ns_detector = cljs.core.nth.call(null,vec__16165,(0),null);
...
var G__16171 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16172 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16171;
remaining_tokens = G__16172;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16162){
var G__16163 = cljs.core.first.call(null,seq16162);
var seq16162__$1 = cljs.core.next.call(null,seq16162);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16163,seq16162__$1);
});
...
var vec__16176 = cljs.core.split_with.call(null,(function (p1__16175_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16175_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16176,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16176,(1),null);
...
var vec__16179 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16179,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16179,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16182 = cljs.core.rest.call(null,remaining_tokens);
var G__16183 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16182;
name_tokens = G__16183;
continue;
} else {
...
var vec__16186 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16186,(0),null);
var arity = cljs.core.nth.call(null,vec__16186,(1),null);
var vec__16189 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16189,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16189,(1),null);
var vec__16192 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16192,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16192,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16192,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16192,(3),null);
...
var vec__16198 = result;
var munged_ns = cljs.core.nth.call(null,vec__16198,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16198,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16198,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16198,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16198,(4),null);
var arity = cljs.core.nth.call(null,vec__16198,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16202 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16202,(0),null);
var args = cljs.core.nth.call(null,vec__16202,(1),null);
var vec__16205 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16205,(0),null);
var name = cljs.core.nth.call(null,vec__16205,(1),null);
...
var G__16208 = (arity + (1));
var G__16209 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16210){
var vec__16211 = p__16210;
var arity = cljs.core.nth.call(null,vec__16211,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16211,(1),null);
...
return cljs.core.get.call(null,arities,p1__16214_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16215_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___16222 = arguments.length;
var i__4532__auto___16223 = (0);
while(true){
if((i__4532__auto___16223 < len__4531__auto___16222)){
args__4534__auto__.push((arguments[i__4532__auto___16223]));

var G__16224 = (i__4532__auto___16223 + (1));
i__4532__auto___16223 = G__16224;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16218){
var vec__16219 = p__16218;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16219,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16216){
var G__16217 = cljs.core.first.call(null,seq16216);
var seq16216__$1 = cljs.core.next.call(null,seq16216);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16217,seq16216__$1);
});
...
var G__16225 = arg;
var G__16225__$1 = (((G__16225 instanceof cljs.core.Keyword))?G__16225.fqn:null);
switch (G__16225__$1) {
...
var map__16227 = options;
var map__16227__$1 = ((((!((map__16227 == null)))?(((((map__16227.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16227.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16227):map__16227);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16227__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16227__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16227__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16227__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16228 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16228,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16228,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16228,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16228,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16228,(4),null);
var arity = cljs.core.nth.call(null,vec__16228,(5),null);
...
var o__15158__auto__ = f;
return (o__15158__auto__["getBasis"]).call(o__15158__auto__);
});
/**
...
}catch (e16232){var _e__15165__auto__ = e16232;
...
var G__16233 = (obj[cljs.core.first.call(null,path)]);
var G__16234 = cljs.core.rest.call(null,path);
obj = G__16233;
path = G__16234;
continue;
} else {
...
return (function (accum,p__16235){
var vec__16236 = p__16235;
var bit = cljs.core.nth.call(null,vec__16236,(0),null);
var protocol = cljs.core.nth.call(null,vec__16236,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16239){
var vec__16240 = p__16239;
var ns = cljs.core.nth.call(null,vec__16240,(0),null);
var name = cljs.core.nth.call(null,vec__16240,(1),null);
var selector = cljs.core.nth.call(null,vec__16240,(2),null);
...
return (function (p__16244){
var vec__16245 = p__16244;
var munged_name = cljs.core.nth.call(null,vec__16245,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16245,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16245,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16243_SHARP_){
return (obj[cljs.core.first.call(null,p1__16243_SHARP_)]);
});})(name,sorted_matches,vec__16245,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
