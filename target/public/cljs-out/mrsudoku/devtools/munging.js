...
var o13538 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13538["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13539 = temp__5718__auto____$1;
return (o13539["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12648__auto__ = f;
return (o__12648__auto__["toString"]).call(o__12648__auto__);
} else {
return "";
}
}catch (e13540){var _ = e13540;
return "";
}});
...
try{var o__12648__auto___13542 = t;
(o__12648__auto___13542["cljs$lang$ctorPrWriter"]).call(o__12648__auto___13542,t,writer);
}catch (e13541){var __13543 = e13541;
}
...
var char_code = (function (){var o__12648__auto__ = (new String(char$));
return (o__12648__auto__["charCodeAt"]).call(o__12648__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12648__auto__ = String;
return (o__12648__auto__["fromCharCode"]).call(o__12648__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13544 = num_code;
switch (G__13544) {
case (1):
return (185);
...
var o__12648__auto__ = String;
return (o__12648__auto__["fromCharCode"]).call(o__12648__auto__,superscript_code);
});
/**
...
}catch (e13546){var _e__12655__auto__ = e13546;
return false;
}})())){
...
var vec__13547 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13547,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o13550 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13550["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13551 = temp__5718__auto____$1;
return (o13551["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___13558 = arguments.length;
var i__4532__auto___13559 = (0);
while(true){
if((i__4532__auto___13559 < len__4531__auto___13558)){
args__4534__auto__.push((arguments[i__4532__auto___13559]));

var G__13560 = (i__4532__auto___13559 + (1));
i__4532__auto___13559 = G__13560;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.call(null,vec__13555,(0),null);
...
var G__13561 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13562 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13561;
remaining_tokens = G__13562;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13552){
var G__13553 = cljs.core.first.call(null,seq13552);
var seq13552__$1 = cljs.core.next.call(null,seq13552);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13553,seq13552__$1);
});
...
var vec__13566 = cljs.core.split_with.call(null,(function (p1__13565_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13565_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13566,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13566,(1),null);
...
var vec__13569 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13569,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13569,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13572 = cljs.core.rest.call(null,remaining_tokens);
var G__13573 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13572;
name_tokens = G__13573;
continue;
} else {
...
var vec__13576 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13576,(0),null);
var arity = cljs.core.nth.call(null,vec__13576,(1),null);
var vec__13579 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13579,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13579,(1),null);
var vec__13582 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13582,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13582,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13582,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13582,(3),null);
...
var vec__13588 = result;
var munged_ns = cljs.core.nth.call(null,vec__13588,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13588,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13588,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13588,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13588,(4),null);
var arity = cljs.core.nth.call(null,vec__13588,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13592 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13592,(0),null);
var args = cljs.core.nth.call(null,vec__13592,(1),null);
var vec__13595 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13595,(0),null);
var name = cljs.core.nth.call(null,vec__13595,(1),null);
...
var G__13598 = (arity + (1));
var G__13599 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13600){
var vec__13601 = p__13600;
var arity = cljs.core.nth.call(null,vec__13601,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13601,(1),null);
...
return cljs.core.get.call(null,arities,p1__13604_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__13605_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13608){
var vec__13609 = p__13608;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13609,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13606){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13617__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13617__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13617__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13617__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13618 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13618,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13618,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13618,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13618,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13618,(4),null);
var arity = cljs.core.nth.call(null,vec__13618,(5),null);
...
var o__12648__auto__ = f;
return (o__12648__auto__["getBasis"]).call(o__12648__auto__);
});
/**
...
}catch (e13622){var _e__12655__auto__ = e13622;
...
var G__13623 = (obj[cljs.core.first.call(null,path)]);
var G__13624 = cljs.core.rest.call(null,path);
obj = G__13623;
path = G__13624;
continue;
} else {
...
return (function (accum,p__13625){
var vec__13626 = p__13625;
var bit = cljs.core.nth.call(null,vec__13626,(0),null);
var protocol = cljs.core.nth.call(null,vec__13626,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13629){
var vec__13630 = p__13629;
var ns = cljs.core.nth.call(null,vec__13630,(0),null);
var name = cljs.core.nth.call(null,vec__13630,(1),null);
var selector = cljs.core.nth.call(null,vec__13630,(2),null);
...
return (function (p__13634){
var vec__13635 = p__13634;
var munged_name = cljs.core.nth.call(null,vec__13635,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13635,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__13635,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13633_SHARP_){
return (obj[cljs.core.first.call(null,p1__13633_SHARP_)]);
});})(name,sorted_matches,vec__13635,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
