...
var temp__5718__auto____$1 = (o15981["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15982 = temp__5718__auto____$1;
return (o15982["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14991__auto__ = f;
return (o__14991__auto__["toString"]).call(o__14991__auto__);
} else {
return "";
}
}catch (e15983){var _ = e15983;
return "";
}});
...
try{var o__14991__auto___15985 = t;
(o__14991__auto___15985["cljs$lang$ctorPrWriter"]).call(o__14991__auto___15985,t,writer);
}catch (e15984){var __15986 = e15984;
}
...
var char_code = (function (){var o__14991__auto__ = (new String(char$));
return (o__14991__auto__["charCodeAt"]).call(o__14991__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14991__auto__ = String;
return (o__14991__auto__["fromCharCode"]).call(o__14991__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15987 = num_code;
switch (G__15987) {
case (1):
return (185);
...
var o__14991__auto__ = String;
return (o__14991__auto__["fromCharCode"]).call(o__14991__auto__,superscript_code);
});
/**
...
}catch (e15989){var _e__14998__auto__ = e15989;
return false;
}})())){
...
var vec__15990 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15990,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o15993 = temp__5718__auto__;
var temp__5718__auto____$1 = (o15993["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o15994 = temp__5718__auto____$1;
return (o15994["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___16001 = arguments.length;
var i__4532__auto___16002 = (0);
while(true){
if((i__4532__auto___16002 < len__4531__auto___16001)){
args__4534__auto__.push((arguments[i__4532__auto___16002]));

var G__16003 = (i__4532__auto___16002 + (1));
i__4532__auto___16002 = G__16003;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15997){
var vec__15998 = p__15997;
var ns_detector = cljs.core.nth.call(null,vec__15998,(0),null);
...
var G__16004 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16005 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16004;
remaining_tokens = G__16005;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15995){
var G__15996 = cljs.core.first.call(null,seq15995);
var seq15995__$1 = cljs.core.next.call(null,seq15995);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15996,seq15995__$1);
});
...
var vec__16009 = cljs.core.split_with.call(null,(function (p1__16008_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16008_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16009,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16009,(1),null);
...
var vec__16012 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16012,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16012,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16015 = cljs.core.rest.call(null,remaining_tokens);
var G__16016 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16015;
name_tokens = G__16016;
continue;
} else {
...
var vec__16019 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16019,(0),null);
var arity = cljs.core.nth.call(null,vec__16019,(1),null);
var vec__16022 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16022,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16022,(1),null);
var vec__16025 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16025,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16025,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16025,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16025,(3),null);
...
var vec__16031 = result;
var munged_ns = cljs.core.nth.call(null,vec__16031,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16031,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16031,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16031,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16031,(4),null);
var arity = cljs.core.nth.call(null,vec__16031,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16035 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16035,(0),null);
var args = cljs.core.nth.call(null,vec__16035,(1),null);
var vec__16038 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16038,(0),null);
var name = cljs.core.nth.call(null,vec__16038,(1),null);
...
var G__16041 = (arity + (1));
var G__16042 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16043){
var vec__16044 = p__16043;
var arity = cljs.core.nth.call(null,vec__16044,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16044,(1),null);
...
return cljs.core.get.call(null,arities,p1__16047_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16048_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___16055 = arguments.length;
var i__4532__auto___16056 = (0);
while(true){
if((i__4532__auto___16056 < len__4531__auto___16055)){
args__4534__auto__.push((arguments[i__4532__auto___16056]));

var G__16057 = (i__4532__auto___16056 + (1));
i__4532__auto___16056 = G__16057;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16051){
var vec__16052 = p__16051;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16052,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16049){
var G__16050 = cljs.core.first.call(null,seq16049);
var seq16049__$1 = cljs.core.next.call(null,seq16049);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16050,seq16049__$1);
});
...
var map__16060 = options;
var map__16060__$1 = ((((!((map__16060 == null)))?(((((map__16060.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16060.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16060):map__16060);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16060__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16060__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16060__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16060__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16061 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16061,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16061,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16061,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16061,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16061,(4),null);
var arity = cljs.core.nth.call(null,vec__16061,(5),null);
...
var o__14991__auto__ = f;
return (o__14991__auto__["getBasis"]).call(o__14991__auto__);
});
/**
...
}catch (e16065){var _e__14998__auto__ = e16065;
...
var G__16066 = (obj[cljs.core.first.call(null,path)]);
var G__16067 = cljs.core.rest.call(null,path);
obj = G__16066;
path = G__16067;
continue;
} else {
...
return (function (accum,p__16068){
var vec__16069 = p__16068;
var bit = cljs.core.nth.call(null,vec__16069,(0),null);
var protocol = cljs.core.nth.call(null,vec__16069,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16072){
var vec__16073 = p__16072;
var ns = cljs.core.nth.call(null,vec__16073,(0),null);
var name = cljs.core.nth.call(null,vec__16073,(1),null);
var selector = cljs.core.nth.call(null,vec__16073,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16078,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16078,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16078,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16076_SHARP_){
return (obj[cljs.core.first.call(null,p1__16076_SHARP_)]);
});})(name,sorted_matches,vec__16078,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
