...
var G__16101 = devtools.prefs.pref.call(null,v);
v = G__16101;
continue;
} else {
return v;
...
}catch (e16104){var _e__14998__auto__ = e16104;
return false;
}})();
...
}catch (e16108){var _e__14998__auto__ = e16108;
return false;
}})();
...
}catch (e16110){var _e__14998__auto__ = e16110;
return false;
}}
}
});
...
var vec__16112 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16112,(0),null);
var name = cljs.core.nth.call(null,vec__16112,(1),null);
...
return cljs.core.some.call(null,(function (p1__16115_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16115_SHARP_);
}),template);
});
