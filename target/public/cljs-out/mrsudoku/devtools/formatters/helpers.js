...
var G__13640 = devtools.prefs.pref.call(null,v);
v = G__13640;
continue;
} else {
return v;
...
}catch (e13643){var _e__12655__auto__ = e13643;
return false;
}})();
...
}catch (e13647){var _e__12655__auto__ = e13647;
return false;
}})();
...
}catch (e13649){var _e__12655__auto__ = e13649;
return false;
}}
}
});
...
var vec__13651 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13651,(0),null);
var name = cljs.core.nth.call(null,vec__13651,(1),null);
...
return cljs.core.some.call(null,(function (p1__13654_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13654_SHARP_);
}),template);
});
