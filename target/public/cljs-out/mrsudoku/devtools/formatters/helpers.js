...
var G__16268 = devtools.prefs.pref.call(null,v);
v = G__16268;
continue;
} else {
return v;
...
}catch (e16271){var _e__15165__auto__ = e16271;
return false;
}})();
...
}catch (e16275){var _e__15165__auto__ = e16275;
return false;
}})();
...
}catch (e16277){var _e__15165__auto__ = e16277;
return false;
}}
}
});
...
var vec__16279 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16279,(0),null);
var name = cljs.core.nth.call(null,vec__16279,(1),null);
...
return cljs.core.some.call(null,(function (p1__16282_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16282_SHARP_);
}),template);
});
