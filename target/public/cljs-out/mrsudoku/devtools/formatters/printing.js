...
var len__4531__auto___16185 = arguments.length;
var i__4532__auto___16186 = (0);
while(true){
if((i__4532__auto___16186 < len__4531__auto___16185)){
args__4534__auto__.push((arguments[i__4532__auto___16186]));

var G__16187 = (i__4532__auto___16186 + (1));
i__4532__auto___16186 = G__16187;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16182){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16183,G__16184,seq16182__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16188_SHARP_){
return !((cljs.core.meta.call(null,p1__16188_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__16189__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16193){var _e__14948__auto__ = e16193;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e16195){var _e__14948__auto__ = e16195;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16197 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16198 = opts;
...
var markup_db = cljs.core.get.call(null,map__16198__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16197;
}});
...
;
var temp__5718__auto___16202 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16202)){
var managed_print_level_16203 = temp__5718__auto___16202;
var _STAR_print_level_STAR_16201_16204 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16203;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16201_16204,managed_print_level_16203,temp__5718__auto___16202,writer,opts,job_fn){
return (function (p1__16200_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16200_SHARP_,null);
});})(_STAR_print_level_STAR_16201_16204,managed_print_level_16203,temp__5718__auto___16202,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16201_16204;
}} else {
job_fn.call(null);
}
