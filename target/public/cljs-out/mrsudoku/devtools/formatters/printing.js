...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16152){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16153,G__16154,seq16152__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16158_SHARP_){
return !((cljs.core.meta.call(null,p1__16158_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__16159__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16163){var _e__14998__auto__ = e16163;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e16165){var _e__14998__auto__ = e16165;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16167 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16168 = opts;
var map__16168__$1 = ((((!((map__16168 == null)))?(((((map__16168.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16168.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16168):map__16168);
var markup_db = cljs.core.get.call(null,map__16168__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16167;
}});
...
;
var temp__5718__auto___16172 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16172)){
var managed_print_level_16173 = temp__5718__auto___16172;
var _STAR_print_level_STAR_16171_16174 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16173;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16171_16174,managed_print_level_16173,temp__5718__auto___16172,writer,opts,job_fn){
return (function (p1__16170_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16170_SHARP_,null);
});})(_STAR_print_level_STAR_16171_16174,managed_print_level_16173,temp__5718__auto___16172,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16171_16174;
}} else {
job_fn.call(null);
}
