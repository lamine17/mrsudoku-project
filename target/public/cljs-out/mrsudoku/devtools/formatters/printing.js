...
var len__4531__auto___16322 = arguments.length;
var i__4532__auto___16323 = (0);
while(true){
if((i__4532__auto___16323 < len__4531__auto___16322)){
args__4534__auto__.push((arguments[i__4532__auto___16323]));

var G__16324 = (i__4532__auto___16323 + (1));
i__4532__auto___16323 = G__16324;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16319){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16320,G__16321,seq16319__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16325_SHARP_){
return !((cljs.core.meta.call(null,p1__16325_SHARP_) == null));
})))){
...
var map__16326 = opts;
var map__16326__$1 = ((((!((map__16326 == null)))?(((((map__16326.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16326.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16326):map__16326);
var markup_db = cljs.core.get.call(null,map__16326__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16330){var _e__15165__auto__ = e16330;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e16332){var _e__15165__auto__ = e16332;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16334 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16335 = opts;
...
var markup_db = cljs.core.get.call(null,map__16335__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16334;
}});
...
;
var temp__5718__auto___16339 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16339)){
var managed_print_level_16340 = temp__5718__auto___16339;
var _STAR_print_level_STAR_16338_16341 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16340;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16338_16341,managed_print_level_16340,temp__5718__auto___16339,writer,opts,job_fn){
return (function (p1__16337_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16337_SHARP_,null);
});})(_STAR_print_level_STAR_16338_16341,managed_print_level_16340,temp__5718__auto___16339,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16338_16341;
}} else {
job_fn.call(null);
}
