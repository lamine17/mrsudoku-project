...
var len__4531__auto___13669 = arguments.length;
var i__4532__auto___13670 = (0);
while(true){
if((i__4532__auto___13670 < len__4531__auto___13669)){
args__4534__auto__.push((arguments[i__4532__auto___13670]));

var G__13671 = (i__4532__auto___13670 + (1));
i__4532__auto___13670 = G__13671;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13666){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13667,G__13668,seq13666__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13672_SHARP_){
return !((cljs.core.meta.call(null,p1__13672_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__13673__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13677){var _e__12655__auto__ = e13677;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e13679){var _e__12655__auto__ = e13679;
return false;
}}
})())){
...
var _STAR_current_state_STAR_13681 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__13682 = opts;
var map__13682__$1 = ((((!((map__13682 == null)))?(((((map__13682.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13682.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13682):map__13682);
var markup_db = cljs.core.get.call(null,map__13682__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_13681;
}});
...
;
var temp__5718__auto___13686 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13686)){
var managed_print_level_13687 = temp__5718__auto___13686;
var _STAR_print_level_STAR_13685_13688 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_13687;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_13685_13688,managed_print_level_13687,temp__5718__auto___13686,writer,opts,job_fn){
return (function (p1__13684_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13684_SHARP_,null);
});})(_STAR_print_level_STAR_13685_13688,managed_print_level_13687,temp__5718__auto___13686,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_13685_13688;
}} else {
job_fn.call(null);
}
