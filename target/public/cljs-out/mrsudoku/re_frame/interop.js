...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9126 = cljs.core.instance_QMARK_;
var expr__9127 = reactive_val;
if(cljs.core.truth_(pred__9126.call(null,reagent.ratom.RAtom,expr__9127))){
return "ra";
} else {
if(cljs.core.truth_(pred__9126.call(null,reagent.ratom.RCursor,expr__9127))){
return "rc";
} else {
if(cljs.core.truth_(pred__9126.call(null,reagent.ratom.Reaction,expr__9127))){
return "rx";
} else {
if(cljs.core.truth_(pred__9126.call(null,reagent.ratom.Track,expr__9127))){
return "tr";
} else {
return "other";
}
