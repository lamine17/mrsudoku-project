...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9476 = cljs.core.instance_QMARK_;
var expr__9477 = reactive_val;
if(cljs.core.truth_(pred__9476.call(null,reagent.ratom.RAtom,expr__9477))){
return "ra";
} else {
if(cljs.core.truth_(pred__9476.call(null,reagent.ratom.RCursor,expr__9477))){
return "rc";
} else {
if(cljs.core.truth_(pred__9476.call(null,reagent.ratom.Reaction,expr__9477))){
return "rx";
} else {
if(cljs.core.truth_(pred__9476.call(null,reagent.ratom.Track,expr__9477))){
return "tr";
} else {
return "other";
}
