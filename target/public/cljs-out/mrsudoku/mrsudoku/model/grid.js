...
return cljs.core.update.call(null,graph,src,(function (p1__8575_SHARP_){
return cljs.core.conj.call(null,p1__8575_SHARP_,dest);
}));
});
mrsudoku.model.grid.remove_edge = (function mrsudoku$model$grid$remove_edge(graph,src,dest){
return cljs.core.update.call(null,graph,src,(function (p1__8576_SHARP_){
return cljs.core.disj.call(null,p1__8576_SHARP_,dest);
}));
});
